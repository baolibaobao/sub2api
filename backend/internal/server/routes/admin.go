...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.GET("/accounts/:id/reauth", h.Admin.OpenAIOAuth.GetReauthStatus)
		openai.PUT("/accounts/:id/reauth-profile", h.Admin.OpenAIOAuth.SaveReauthProfile)
		openai.PATCH("/accounts/:id/reauth-profile", h.Admin.OpenAIOAuth.SetReauthProfileEnabled)
		openai.DELETE("/accounts/:id/reauth-profile", h.Admin.OpenAIOAuth.DeleteReauthProfile)
		openai.POST("/accounts/:id/reauth", h.Admin.OpenAIOAuth.EnqueueReauth)
